...
const welcomeCopy = {
  zh: {
    ...
    noSuggestions: "没有找到已生成的 vault 建议。",
    openDemo: "打开 DeepSeek demo vault",
    createTitle: "创建新的 Wiki Project",
    createSubtitle: "选择本地 project template。Runtime 保持本地优先，写回保持 proposal-first。",
    ...
    switchTo: "切换为",
    templates: {
      research: ["研究", "证据、claims、reviews 和 writeback。", "用于论文/资料研究的 wiki，包含 source-backed claims 和 review queues。"],
      reading: ["阅读", "书籍、笔记、source pages 和 summaries。", "用于阅读笔记、摘要和引用管理的知识库。"],
      "personal-growth": ["个人成长", "学习目标、概念和复盘。", "用于学习、反思和规划的个人成长 wiki。"],
      business: ["商业", "市场笔记、决策和策略 brief。", "用于决策、市场研究和运营知识沉淀的 business wiki。"],
      general: ["通用", "干净的本地优先 wiki project。", "用于混合知识工作的通用 wiki。"],
    },
  },
  en: {
