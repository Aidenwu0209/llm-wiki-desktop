...
const settingsCopy = {
  zh: {
    ...
    reasoning: "推理 / 思考强度",
    deepThinking: "深度思考",
    placeholder: "该分区已预留产品设置入口；核心 runtime 控制保留在下方。",
    runtime: "Runtime",
  ...
  en: {
    ...
    local: "Local",
    activeKeyHidden: "Active, key hidden",
    off: "Off",
    ...
    recheck: "Re-check",
    apiNote: "API key status is stored outside this UI. Keys are never displayed as plain text.",
    customModel: "Custom model",
    optionalOverride: "Optional override",
    contextWindow: "Context window",
    reasoning: "Reasoning / thinking",
    deepThinking: "deep thinking",
    placeholder: "This section is ready for product settings. Core runtime controls remain available below.",
    runtime: "Runtime",
