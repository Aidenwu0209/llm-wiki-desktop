...
export const paddleOcrVl15Provider = {
  ...
  subtitle: "Default OCR parser for PDF/image ingest, gated by endpoint and PADDLEOCR_API_KEY.",
  subtitleZh: "PDF / 图片 ingest 默认 OCR parser，由 endpoint 和 PADDLEOCR_API_KEY 配置门控。",
  providerType: "hosted",
